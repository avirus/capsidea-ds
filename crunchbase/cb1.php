...
while (false) {
//$url="http://api.crunchbase.com/v/2/organizations?user_key=fefe934cf6f3fe2545a50955ee054baf&page=$i&order=created_at+DESC";
...
foreach (	$js->data->relationships->investments->items as $funding) {
	...
	$fround=null;
	if (file_exists($round_fname)) {	
		$fround=json_decode(file_get_contents($round_fname));
		echo  "+";
	} 
