...
$host_reply=askhost($server_url, array('file_contents'=>'@'."$my_data_dir/usrates.csv"),"","","",80000,array("appid: $capsidea_appid","sig: $secret"),true);// defined in askhost.php
...
<link rel=\"stylesheet\" type=\"text/css\" href=\"view.css\" media=\"all\"></head><body id=\"main_body\" ";
	...
	<h1><b>Source $key created</b></h1><br>RES:  <pre>$error_log</pre><br>$jsondash<div id=\"footer\"></div></div><img id=\"bottom\" src=\"bottom.png\" alt=\"\"></body></html>";
	die();}
